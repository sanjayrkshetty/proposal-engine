...
and position Proposal Engine as the trusted partner. Be professional and concise.
...
class ProposalAgent(BaseAgent):
    def run(self, brief_data: dict, scope_data: dict, client_info: dict,
        ...
        if not billing_contact:
            billing_contact = "billing@proposalengine.io | +91-80-4040-5050"
    ...
    def _generate_exec_summary(self, brief_data: dict, scope_data: dict,
        ...
        if exec_summary_context and len(exec_summary_context) > 50:
            ...
            return (
                ...
                f"Proposal Engine proposes a {tier}-tier {self.config.get('name', 'security engagement')} "
...
Proposal Engine is a global payment and cybersecurity company, specialising in forensics, compliance, and managed security services. Founded in 2012 and headquartered in Bengaluru, India, Proposal Engine has protected over 1,000 organisations across 40+ countries. Proposal Engine is the only forensics company in Asia-Pacific accredited as both a PCI Forensic Investigator (PFI) and a QSA company by the PCI Security Standards Council. Our team of 200+ certified security professionals holds GCFA, GCIH, CREST, CISSP, and CISM credentials, delivering world-class security outcomes for financial institutions, healthcare organisations, and critical infrastructure operators.
...
4. Proposal Engine retains the right to withdraw or amend this proposal if material information is found to be inaccurate.
...
7. Data handling: All client data processed during the engagement is handled per Our ISO 27001-certified data handling procedures.

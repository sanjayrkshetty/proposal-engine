...
class ProposalAgent(BaseAgent):
    ...
    def run(self, brief_data: dict, scope_data: dict, client_info: dict,
        ...
        # Adversarial critique pass — improve exec summary before rendering
        try:
            ...
            if critiques:
                exec_summary = critic.improve_exec_summary(exec_summary, critiques)
        except Exception:
            pass
        ...
        signature = (
            "\n\n---\n"
            "*Generated by [Proposal Engine](https://github.com/sanjayrkshetty/proposal-engine) "
            "· Built by [Sanjay R K Shetty](https://github.com/sanjayrkshetty) "
